...
function CarListOption({ distance, isSharing }) {
  ...
  return (
    <div className=" p-2  h-[350px]"  >
      ...
      <div className=" p-2 m-2 overflow-auto h-[280px]">
      ...
      <div>
        ...
        {!loading && selectedCar?.name && (
          <div className="flex  justify-between rounded-lg bg-white text-black z-90 p-1 shadow-xl w-full md:w-[100%] border-[1px] items-center">
